...
function testimonies() {
  return (
    <div>
        <section id="testimonies" class="py-20 bg-slate-100 p-10">
    <div class="max-w-6xl mx-8 md:mx-10 lg:mx-20 xl:mx-auto">
        ...
        <div class="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
            <div class="mb-12 space-y-5 md:mb-16 md:text-center">
                ...
                <h1 class="mb-5 text-3xl font-semibold text-slate-800 md:text-center md:text-5xl">
                    It's not just us.
                </h1>
            ...
            <ul class="space-y-8">
                <li class="text-sm leading-6">
                    <div class="relative group">
                        <div
                            class="absolute transition rounded-lg opacity-25 -inset-1 bg-gradient-to-r from-slate-600 to-grey-100 blur duration-400 group-hover:opacity-100 group-hover:duration-200">
                        </div><a href="https://twitter.com/kanyewest" class="cursor-pointer">
                            <div
                                class="relative p-6 space-y-6 leading-none rounded-lg bg-slate-300 ring-1 ring-gray-900/5">
                    ...
                    <div class="relative group">
                        <div
                            ...
                            <div
                                ...
                                <p class="leading-normal text-slate-800 text-md">Diam quis enim lobortis scelerisque
                    ...
                    <div class="relative group">
                        <div
                            ...
                            <div
                                ...
                                <p class="leading-normal text-slate-800text-md">Diam quis enim lobortis scelerisque
                                    fermentum dui faucibus in ornare. Donec pretium vulputate sapien nec sagittis
                                    aliquam malesuada bibendum.</p>
                            </div>
                        </a>
                    ...
                    <div class="relative group">
                        <div
                            ...
                            <div
                                ...
                                <p class="leading-normal text-slate-800 text-md">Enim neque volutpat ac tincidunt vitae
                    ...
                    <div class="relative group">
                        <div
                            ...
                            <div
                                ...
                                <p class="leading-normal text-slate-800 text-md">Tortor dignissim convallis aenean et
                    ...
                    <div class="relative group">
                        <div
                            ...
                            <div
                                ...
                                <p class="leading-normal text-slate-800 text-md">Quam pellentesque nec nam aliquam sem
                    ...
                    <div class="relative group">
                        <div
                            ...
                            <div
                                ...
                                <p class="leading-normal text-slate-800text-md">Quam pellentesque nec nam aliquam sem
                                    et tortor consequat id. Enim sit amet venenatis urna cursus.</p>
                            </div>
                        </a>
                    </div>
